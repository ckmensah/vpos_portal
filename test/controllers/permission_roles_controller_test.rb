...
class PermissionRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission_role" do
    assert_difference('PermissionRole.count') do
      post permission_roles_url, params: { permission_role: { active_status: @permission_role.active_status, del_status: @permission_role.del_status, permission_id: @permission_role.permission_id, role_id: @permission_role.role_id, user_id: @permission_role.user_id } }
    end
  ...
  test "should update permission_role" do
    patch permission_role_url(@permission_role), params: { permission_role: { active_status: @permission_role.active_status, del_status: @permission_role.del_status, permission_id: @permission_role.permission_id, role_id: @permission_role.role_id, user_id: @permission_role.user_id } }
