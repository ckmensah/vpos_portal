class AssignedServiceCodesController < ApplicationController
  ...
  private
    ...
    def assigned_service_code_params
      params.require(:assigned_service_code).permit(:entity_div_code, :service_code, :comment, :active_status, :del_status, :user_id,:company_code, :company_url, :rate_status)
    end
end
